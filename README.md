This is a personal exercise in using Jupyter Notebook(Python) and R to do analysis of what ESG(Environmental Social Governance) Score effects on stock performance and
